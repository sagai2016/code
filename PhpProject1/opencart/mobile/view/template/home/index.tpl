...
.main .header {
	width: 100%;
	background: url(../mobile/view/image/t1.png) no-repeat;
...
.main .ad1 {
	width: 100%;
	background: url(../mobile/view/image/t2.png) no-repeat;
	background-size: 100% auto;
	height: 30%;
	overflow: hidden;
}
.main .ad2 {
	margin: 2% 0;
	height: 15%;
	background: url(../mobile/view/image/t3.png) no-repeat;
	background-size: 100% auto;
}
.main .adList {
	height: 45%;
...
.main .adList .title {
	height: 13%;
	background: url(../mobile/view/image/t4.png) no-repeat;
	background-size: 100% auto;
}
...
<div class="main">
      ...
      <div class="bannerPane">
        <section class="slider">
          <div class="flexslider">
            <ul class="slides">
              <li><a href="javascript:;"><img src="../mobile/view/image/t2.png" alt="懒人之家" /></a></li>
              <li><a href="javascript:;"><img src="../mobile/view/image/t2-2.png" alt="懒人之家" /></a></li>
              <li><a href="javascript:;"><img src="../mobile/view/image/t2.png" alt="懒人之家" /></a></li>
              <li><a href="javascript:;"><img src="../mobile/view/image/t2-2.png" alt="懒人之家" /></a></li>
            </ul>
          </div>
  ...
  <div class="adList">
    <ul>
      <li class="title"></li>
      <li class="goodsList"> <span> <a  href=""><img src="../mobile/view/image/t5.png"></a> <a  href=""><img src="../mobile/view/image/t5.png"></a> </span> </li>
    </ul>
  </div>
</div>
<div class="main2"> <a><img src="../mobile/view/image/t6.png"></a> <a><img src="../mobile/view/image/t6.png"></a><a><img src="../mobile/view/image/t6.png"></a> <a><img src="../mobile/view/image/t6.png"></a> </div>
<div class="foot">
  <ul>
