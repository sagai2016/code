<html lang="en">
    <header>
        ...
        <link href="../webfile/css/bootstrap.min.css" rel="stylesheet" media="screen" />
        <script src="../webfile/js/bootstrap.min.js" type="text/javascript"></script>
        <link href="../webfile/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
        <link href="../webfile/css/stylesheet.css" rel="stylesheet">
        ...
        <link href="../webfile/css/magnific-popup.css" type="text/css" rel="stylesheet" media="screen" />
        <link href="../webfile/css/bootstrap-datetimepicker.min.css" type="text/css" rel="stylesheet" media="screen" />
