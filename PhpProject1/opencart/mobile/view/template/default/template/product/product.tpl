...
<body>   
<div class="QRCode"><img src="image/catalog/demo/manufacturer/3f2d1b27779dd9cf712eac213e01698c.jpg"></div>
...
<script>
    ...
    $('.gzc').click(function(){
        ...
        $(".QRCode").animate({"left": "-590px"}, "slow");      
    })
    });
...
//获取“分享给朋友”按钮点击状态及自定义分享内容接口
        wx.onMenuShareAppMessage({
            ...
            desc: '分享描述', // 分享描述
            link: 'bidu.com', // 分享链接
            imgUrl: 'image/catelog/no_image.png' // 分享图标
