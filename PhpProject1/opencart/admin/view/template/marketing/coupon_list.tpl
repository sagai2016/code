              ...
              <thead>
                <tr>
                  ...
                  <td class="text-right"><?php if ($sort == 'discount') { ?>
                    <a href="<?php echo $sort_discount; ?>" <?php echo 'class="'. strtolower($order) .'"'; ?>><?php echo $column_discount; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_discount; ?>"><?php echo $column_discount; ?></a>
                    <?php } ?></td>
                  <td class="text-left"><?php if ($sort == 'date_start') { ?>
                    <a href="<?php echo $sort_date_start; ?>" <?php echo 'class="'. strtolower($order) .'"'; ?>><?php echo $column_date_start; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_date_start; ?>"><?php echo $column_date_start; ?></a>
                    <?php } ?></td>
                  <td class="text-left"><?php if ($sort == 'date_end') { ?>
                    <a href="<?php echo $sort_date_end; ?>" <?php echo 'class="'. strtolower($order) .'"'; ?>><?php echo $column_date_end; ?></a>
                    <?php } else { ?>
